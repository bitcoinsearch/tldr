...
export const baseUrl = (query: string) => {
  return `https://bitcoinsearch.xyz/?search=${encodeURI(
    query
  )}&utm_source=tldr.bitcoinsearch.xyz&filter_domain=https%3A%2F%2Fmailing-list.bitcoindevs.xyz%2Fbitcoindev%2F&filter_domain=https%3A%2F%2Flists.linuxfoundation.org%2Fpipermail%2Fbitcoin-dev%2F&filter_domain=https%3A%2F%2Fdelvingbitcoin.org%2F&filter_domain=https%3A%2F%2Flists.linuxfoundation.org%2Fpipermail%2Flightning-dev%2F`;
};
