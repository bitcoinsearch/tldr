...
const HistoricConversations = ({ posts }: { posts: (HomepageEntryData & { firstPostDate: string; lastPostDate: string })[] }) => {
  ...
  return (
    <div className='flex flex-col gap-6 max-w-[866px] mx-auto '>
      <div className='flex items-end justify-end w-ful'>
        ...
        >
          <span>
            <Image src={`/icons/randomise-icon.svg`} width={16} height={17} alt='' />
          </span>
          Randomise
        </button>
      </div>
